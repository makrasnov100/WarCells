...
public class AttackController : MonoBehaviour
{
    ...
    public void EditUnitsSent()
    {
        ...
        turnController.unitCurrent.text = "" + (int)turnController.unitAmountInput.value;

        if (originCell != null)
            originCell.GetComponent<CellIdentity>().UpdateReserveIndicator((int)turnController.unitAmountInput.value);
    }

    void ConfirmDefence()
    {
        originCell.GetComponent<CellIdentity>().SetReserveUnits((int)turnController.unitAmountInput.value);
